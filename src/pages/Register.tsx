...
import { Moon, Eye, EyeOff, Mail, User, Lock, ArrowRight } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to Pleasant Sleep. You can now sign in.",
      });
      setLoading(false);
      navigate('/login');
    }, 1500);
        ...
        <div className="max-w-md mx-auto">
          <Card className="border-border/40 shadow-md">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription>
                Enter your information to get started with Pleasant Sleep
              </CardDescription>
            </CardHeader>
            <CardContent>
