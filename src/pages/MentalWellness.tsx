            ...
            <CardContent>
              <div className="text-center py-4">
                <div className="flex justify-center items-center h-16 mb-2">
                  {moodData.today.mood === "calm" && (
                    <div className="text-5xl">😌</div>
                  )}
                  {moodData.today.mood === "happy" && (
                    <div className="text-5xl">😊</div>
                  )}
                  {moodData.today.mood === "stressed" && (
                    <div className="text-5xl">😰</div>
                  )}
                  {moodData.today.mood === "anxious" && (
                    <div className="text-5xl">😟</div>
                  )}
                </div>
                <p className="text-xl font-medium capitalize">{moodData.today.mood}</p>
                <p className="text-sm text-muted-foreground mt-1">Intensity: {moodData.today.intensity}/10</p>
              </div>
              ...
              <div className="text-sm mt-4">
                ...
                <p className="text-muted-foreground pl-6">{moodData.today.notes}</p>
              </div>
            </CardContent>
          </Card>
